...
$config = require _DIR_ . '/../bootstrap.php';

require_once _DIR_ . '/../includes/db.php';

require_once _DIR_ . '/../includes/permissions.php';

require_once _DIR_ . '/../includes/session_guard.php';
...
<body>
    ...
    <?php require _DIR_ . '/../includes/footer.php'; ?>
